...
export const DEFAULT_DESIGN_SYSTEM: DesignSystem = {
  ...
  bottomAppBar: { enabled: true, background: '#FFFFFF', textColor: '#607579', activeColor: '#0A607A', inactiveColor: '#718488', indicatorColor: '#0A607A', activeIndicator: 'pill', height: 68, iconSize: 22, labelSize: 10.5, itemGap: 2, radius: 20, shadow: 'floating', blur: 18, opacity: 0.98, position: 'floating', safeArea: 10, desktopVisible: false, mobileVisible: true },
