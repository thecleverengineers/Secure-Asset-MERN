...
export async function updateRazorpaySettings(body: { keyId: string; secret?: string; upiId: string; upiName: string; upiQrUrl?: string }) { return request<ApiResponse<Record<string, any>>>('/integrations/razorpay', { method: 'PATCH', body: JSON.stringify(body) }); }
