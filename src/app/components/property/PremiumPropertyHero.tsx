    ...
    >
      <Box sx={{ p: { xs: 1.5, sm: 2.25, md: 3 } }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: 'minmax(0, 1fr)', lg: 'minmax(0, 1fr) 315px' }, gap: { xs: 1.5, lg: 2.25 }, mt: { xs: 1.5, md: 2.25 } }}>
          <Box sx={{ minWidth: 0 }}>
            {tab === 'photos' ? <>
              <Box sx={{ display: 'grid', gridTemplateColumns: { xs: 'minmax(0, 1fr)', sm: hasGalleryRail ? 'minmax(0, 1.65fr) minmax(135px, .65fr)' : 'minmax(0, 1fr)' }, gap: 1, height: mediaFrameHeight, minWidth: 0, minHeight: 0 }}>
