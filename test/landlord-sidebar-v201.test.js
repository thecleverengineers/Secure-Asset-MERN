...
const requestedKeys = [
  'my-listings', 'applications', 'tenancies', 'property-visits', 'rental-invoices', 'utility-readings',
  'leases', 'payments', 'agreement-templates', 'survey-projects', 'active-projects',
];
const requestedLabels = [
  'My Listings', 'Tenant Applications', 'Active Tenancy', 'Manage Site Visit', 'Rent Management',
...
test('v202 landlord sidebar contains exactly the requested landlord feature keys in order', () => {
  assert.match(shell, /const LANDLORD_FEATURE_MENU_KEYS = \['my-listings', 'applications', 'tenancies', 'property-visits', 'rental-invoices', 'utility-readings', 'leases', 'payments', 'agreement-templates', 'survey-projects', 'active-projects'\]/);
