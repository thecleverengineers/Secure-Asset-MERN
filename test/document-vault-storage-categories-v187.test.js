...
test('v187 removes the VR quick-access surface and adds Land Patta to protected storage', () => {
  for (const token of ['PAN Card', 'Birth Certificate', 'Indian Passport', 'Voter ID', 'Aadhaar Card', 'Driving Licence', 'Land Patta']) {
  ...
  assert.match(vault, /data-secureasset-document-vault-storage-categories-v187="document-essentials-v187"/);
